...
```
using the pandas library to create a DataFrame and perform some basic operations on it. 


    Import the pandas library and create an alias 'pd'.
    Create a dictionary 'zoneTemperatures' containing data with three columns: 'Zones', 'Temperature', and 'Altitude'.
    Create a DataFrame 'df' from the 'zoneTemperatures' dictionary.
    Print the DataFrame 'df' to the console.
    Calculate and print the number of rows in the DataFrame.
    Calculate and print the number of columns in the DataFrame.
